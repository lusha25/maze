...
Choose a difficulty level by clicking the respective button:
...
The game timer will start based on the difficulty selected.

Navigate the maze to find the correct path.

If stuck, the automated solution can be triggered.

Click the "Clear" button to reset the solution.
